...
public class PlayerController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        timeSlider.addEventHandler(MouseEvent.MOUSE_PRESSED, new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent e) {
                ...
                pressTime = mediaPlayer.getCurrentTime();
                pressX = e.getX();
                mediaPlayer.pause();
            }
        });
        ...
        timeSlider.addEventHandler(MouseEvent.MOUSE_RELEASED, new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent e) {
                ...
                dropX = e.getX();
                mediaPlayer.setStartTime(getStartPosition());
                mediaPlayer.play();
            }
        });
    }
    ...
    private Duration getStartPosition() {
        
        Duration startPoint = pressTime;
        double movedX = dropX/pressX;
        
        return startPoint.multiply(movedX);
    }
